...
def print_death_age(people_dict):
    ...
    for key in people_dict:
        print(f'{people_dict[key][0]}  {people_dict[key][3] - people_dict[key][2]}')
...
def count_genders(people_dict):
    ...
    print('Genders')
    for key in people_dict:
        if people_dict[key][1] == 'M':
            cnt_males += 1
        else:
            cnt_females += 1
    print(f'There are {cnt_males} males and {cnt_females} females')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key in marriages_dict:
        print(f'{people_dict[marriages_dict[key][0]][0]} {marriages_dict[key][2] - people_dict[marriages_dict[key][0]][2]} < {marriages_dict[key][2]}  {people_dict[marriages_dict[key][1]][0]} {marriages_dict[key][2] - people_dict[marriages_dict[key][1]][2]}')
