...
def test_get_verb():
    # 1. Test the single past tense verbs.
    ...
    # 2. Test the single and present verbs.
    ...
    # 3. Test the plural and present verbs.
...
def test_get_preposotion():
    # 1. Test the single determiners.

    single_prepositions = ["about", "above", "across", "after", "along", "around", "at", "before", "behind", "below", "beyond", "by", "despite", "except", "for", "from", "in", "into", "near", "of", "off", "on", "onto", "out", "over", "past", "to", "under", "with", "without"]
    ...
    for _ in range(30):
        ...
        # Verify that the word returned from get_determiner
        # is one of the words in the single_determiners list.
        assert word.lower() in single_prepositions

def test_get_preposotional_phase():
    # Split the function
    phrase = get_prepositional_phrase(1)
    split_phrase = phrase.split(" ")
    assert len(split_phrase) == 3
